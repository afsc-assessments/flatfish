...
PARAMETER_SECTION
 ...
 //fix q1 to be 1 otherwise it went to lower bound of .5
  init_bounded_number Blob_factor(1,2,2); //multiplier in 2014, 2015, 2016  
  //matrix M_vec(1,2,styr-20,endyr); //multiplier for natural mortality - 1 except in 2014-2016 
...
//length obs sex ratio in surveys (all combined); proportion of males     
  ...
  obs_SD_sexr=std_dev(obs_sexr_srv_2(1)); 
   ...
   //M_vec(1,i)=1 ;M_vec(2,i)=1;
   //}                         
   //M_vec(1,2014)=Blob_factor;M_vec(2,2014)=Blob_factor; 
   //M_vec(1,2015)=Blob_factor;M_vec(2,2015)=Blob_factor; 
   //M_vec(1,2016)=Blob_factor;M_vec(2,2016)=Blob_factor; 
  //cout<<"M_vec"<<M_vec<<std::endl;  
...
REPORT_SECTION     
  ...
  report<<"Blob_factor"<<endl<<Blob_factor<<endl; 

...
library(here)
set_here("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs")
```
...
source(here("../R/prelims.R"))
YFS=read_rep(here("/runs/m2/fm.rep"))
extra_sd=read.table(here("/runs/m2/extra_sd.rep"),header=TRUE)
B0=formatC(1000*YFS$`#Bzero`,format="d",big.mark=",")
```
...
#### Changes in the data
   ...
   2. Fishery age composition data was updated for `r thisyr-1`.
   3. Survey age composition data was included for `r thisyr`.
   4. The estimates of the retained and discarded portions of the `r thisyr-1` catch were added.
   5. The estimate of the total catch was made through the end of `r thisyr+1`. Catch of xxx t was assumed for the `r thisyr+1` and `r thisyr+2` projections.

### Changes in the assessment methods

Two new models were included that explored incorporating survey start date and its interaction term with annual bottom water temperature in the survey catchability equation.  
...
Tier	&	1a	&	1a	&	1a	&	1a \\
Projected total (age 6+) biomass (t)	& 2,553,100 t & 2,460,700 t &	`r formatC(extra_sd[1,4]*1000,format="d",big.mark=",")` t	   &	`r formatC(extra_sd[2,4]*1000,format="d",big.mark=",")` t  \\
Projected female spawning biomass (t) &	895,600 t	&	890,000 t	&		`r formatC(extra_sd$SSB[1]*1000,format="d",big.mark=",")` t	         &	`r formatC(extra_sd$SSB[2]*1000,format="d",big.mark=",")` t	 \\
$   B_0$                                 &	1,204,000 t	&		&		`r formatC(B0,format="d",big.mark=",")` t	       &	    \\
$   B_{msy}$                             &	456,000 t 	&	 	&		`r formatC(1000*extra_sd$Bmsy[1],format="d",big.mark=",")` t	     &		  \\
$F_{OFL}$                             &	0.12	      &	0.12	      &		`r round(extra_sd$AM_Fmsyr[1],3)`	   &	`r round(extra_sd$AM_Fmsyr[2],3)`	\\
$maxF_{ABC}$                          & 0.109	      &	0.109	      &	  `r round(extra_sd$HM_Fmsyr[1],3)`	     &	`r round(extra_sd$HM_Fmsyr[2],3)`  	\\
$F_{ABC}$                             &	0.109       &	0.109       &		`r round(extra_sd$HM_Fmsyr[1],3)`           &	`r round(extra_sd$HM_Fmsyr[2],3)`        \\
$OFL$    	                            &	306,700 t	&	295,600 t	&	  `r formatC(1000*extra_sd$OFL_AM[1],format="d",big.mark=",")` t          &	`r formatC(1000*extra_sd$OFL_AM[2],format="d",big.mark=",")` t       \\
$maxABC$    	                        &	277,500 t	&	267,500 t	&		`r formatC(1000*extra_sd$ABC_HM[1],format="d",big.mark=",") ` t      &	`r formatC(1000*extra_sd$ABC_HM[2],format="d",big.mark=",") ` t   \\
$ABC$ 	                             &	277,500 t	&	267,500 t	&		`r formatC(1000*extra_sd$ABC_HM[1],format="d",big.mark=",") ` t         &	`r formatC(1000*extra_sd$ABC_HM[2],format="d",big.mark=",")` t       \\
\hline
...
tab.1_cap <- table_nums(name = "tab_1", caption = paste("Foreign and domestic datch (t) of yellowfin sole 1964-",thisyr,".  Foreign catches are designated as joint venture processing (JVP) and domestic annual processing (DAP). Catch for ",thisyr," is an estimate through the end of the year.",sep=""))

tab.2_cap <- table_nums(name = "tab_2", caption = paste("Estimates of retained and discarded (t) yellowfin sole caught in Bering Sea fisheries through September 25th, ",thisyr,", and the proportion discarded.",sep=""))
...
tab.6_cap <- table_nums(name = "tab_6", caption = paste("Yellowfin sole population numbers-at-age (millions of fish) estimated from the annual EBS bottom trawl surveys, 1982-",thisyr,", for ages 2 through 17+. Numbers-at-age from 1982-1986 come from the standard survey area, and years 1987 forward come from the 'plusnw' extended survey area. Females are presented first, followed by males.",sep=""))
...
tab.8_cap <- table_nums(name = "tab_8", caption = paste("Total tonnage of yellowfin sole caught in resource assessment surveys in the eastern Bering Sea from 1977-",thisyr,"."))

tab.9_cap <- table_nums(name = "tab_9", caption = "Mean length and raw weight at age for yellowfin sole, females presented first, followed by males.")
...
tab.17_cap <- table_nums(name = "tab_17", caption = paste("Model estimates of yellowfin sole age 1+ total biomass (t) and begin-year female spawning biomass (t) from the ",thisyr-1," and ",thisyr," stock assessments.",sep=""))

tab.18_cap <- table_nums(name = "tab_18", caption = "Model estimates of yellowfin sole population numbers at age (millions of fish) for 1954-2018.")

tab.19_cap <- table_nums(name = "tab_19", caption = "Model estimates of the number of female spawners (millions) 1964-2018.")

tab.20_cap <- table_nums(name = "tab_20", caption = "Model estimates of yellowfin sole age 5 recruitment (millions of fish) from the 2017 and 2018 stock assessments.")
...
tab.23_cap <- table_nums(name = "tab_23", caption = paste("Catch and bycatch (t) of other BSAI target species in the yellowfin sole directed fishery from 1992-",thisyr,". Note: SR = Shortraker, RE = Rougheye, RF = Rockfish. Source: NMFS AKRO BLEND/Catch Accounting System.",sep=""))

tab.24_cap <- table_nums(name = "tab_24", caption = paste("Estimated non-target species catch (t) in the yellowfin sole fishery, 2003-",thisyr," (Prohibited species catch not included).",sep=""))

tab.25_cap <- table_nums(name = "tab_25", caption = paste("Yellowfin sole TAC, ABC, and total catch (t), 1980-",thisyr,".",sep=""))
...
fig.7_cap = figure_nums(name="fig_7",caption = paste("Difference between the 1985-",thisyr," average trawl survey CPUE for yellowfin sole and the ",thisyr," survey CPUE.  Open circles indicate that the magnitude of the catch was greater in ",thisyr," than the long-term average, closed circles indicate the catch was greater in the long-term average than in ",thisyr,".",sep=""))
...
catchZ=read.csv(here("/doc/Rmd/catch_YFS.csv"),header=TRUE,skip=1)
...
retdis=read.csv(here("/doc/Rmd/RetDis_full.csv"),header=TRUE)#Sept 25 2019
...
srvbio=cbind(YFS$`#yr_bts`,formatC(1000*YFS$`#ob_bts`,format="d",big.mark=","),formatC(1000*YFS$`#ob_bts`-1.96*YFS$`#sd_ob_bts`,format="d",big.mark=","),formatC(1000*YFS$`#ob_bts`+1.96*YFS$`#sd_ob_bts`,format="d",big.mark=","))
...
`r table_nums('tab_6')`
```{r tab_6}
catage_p=read.csv(here("doc/Rmd/YFS_EBS_survey/yfs_agecomp_ebs_plusnw.csv"),header=TRUE)
catage_s=read.csv(here("doc/Rmd/YFS_EBS_survey/yfs_agecomp_ebs_standard.csv"),header=TRUE)
...
for(i in 1:length(yrs)){
 for(j in 1:15)
 {
  if (yrs[i] %in% c(1982:1986)){
   ...
   catage_f[i,16]=sum(catage_s$AGEPOP[which(catage_s$YEAR==yrs[i]&catage_s$SEX==2&catage_s$AGE>=17&catage_s$SUBAREA==999999)])
  ...
  catage_m[i,16]=sum(catage_s$AGEPOP[which(catage_s$YEAR==yrs[i]&catage_s$SEX==1&catage_s$AGE>=17&catage_s$SUBAREA==999999)])
  }
  if (yrs[i] >=1987){
  ...
  catage_f[i,16]=sum(catage_p$AGEPOP[which(catage_p$YEAR==yrs[i]&catage_p$SEX==2&catage_p$AGE>=17&catage_p$SUBAREA==999999)])
  ...
  catage_m[i,16]=sum(catage_p$AGEPOP[which(catage_p$YEAR==yrs[i]&catage_p$SEX==1&catage_p$AGE>=17&catage_p$SUBAREA==999999)])
  }
 }
}
...
`r table_nums('tab_7')`
```{r tab_7}
haul_oto=read.csv(here("/doc/Rmd/Hauls_otoliths.csv"),header=TRUE)
...
rescatch=read.csv(here("/doc/Rmd/ResearchCatch.csv"),header=TRUE)
...
`r table_nums('tab_9')`
```{r tab_9}
wt_f=YFS$`#wt_srv_f`[11:65,]
wt_m=YFS$`#wt_srv_m`[11:65,]
...
mat=read.csv(here("/doc/Rmd/maturity_T10.csv"),header=TRUE)
...
`r table_nums('tab_15')`
```{r tab_15}
Fmort=cbind(seq(1975,thisyr,1),round(YFS$Fmort[22:65],2),round(as.numeric(sub(",", "", as.character(catchZ$Total[12:55]), fixed = TRUE))/(1000*YFS$`#TotBiom`[22:65,2]),2))
colnames(Fmort)=c("Year","Full selection F","Exploitation rate")
kable(Fmort,"latex",booktabs=T,linesep="",longtable=FALSE)
...
`r table_nums('tab_17')`
```{r tab_17}
ssb_bio=cbind(YFS$`#SSB`*1000,YFS$`#TotBiom`*1000)
ssb_bio1=formatC(ssb_bio[11:65,c(2,4,5,7,9,10)],format="d",big.mark=",")
colnames(ssb_bio1)=c("2018 Assessment FSB","Lower 95% CI","Upper 95% CI","Total biomass","Lower 95% CI","Upper 95% CI")
rownames(ssb_bio1)=seq(1964,thisyr,1)
kable(ssb_bio1,"latex",booktabs=T,linesep="",align="r",longtable=FALSE)%>%kable_styling(latex_options="scale_down")
```
...
`r table_nums('tab_18')`
```{r tab_18}  
natage_f=round(YFS$natage_f,2)
rownames(natage_f)=seq(1954,thisyr,1)
colnames(natage_f)=c(seq(1,19,1),"20+")
print(kable(formatC(natage_f*1000,format="d",big.mark=","),"latex",booktabs=T,linesep="",align="r")%>%kable_styling(latex_options="scale_down")%>%add_header_above(c("Year", "Age (Females)"=20 )))

natage_m=round(YFS$natage_m,2)
rownames(natage_m)=seq(1954,thisyr,1)
colnames(natage_m)=c(seq(1,19,1),"20+")
print(kable(formatC(natage_m*1000,format="d",big.mark=","),"latex",booktabs=T,linesep="",align="r")%>%kable_styling(latex_options="scale_down")%>%add_header_above(c("Year", "Age (Males)"=20 )))
...
`r table_nums('tab_21')`
```{r tab_21}
pars=read.table(here("/runs/m1/fm.std"),header=TRUE)
colnames(pars)=c("index","name","value","std.dev")
pars1=pars[which(pars$name %in% c("R_logalpha","R_logbeta","Fmsy","logFmsy","sel_slope_srv","sel50_srv","sel_slope_srv_m","sel50_srv_m","sel50_fsh_m","sel_slope_fsh_m","sel50_fsh_f","sel_slope_fsh_f","log_avg_fmort","mean_log_rec","q_alpha","q_beta[1]")),]

nam_p1=c("alpha (q-temp model)","beta (q-temp model)", "mean log(recruitment)","log(mean(fishing mortality","female fishery selectivity slope","female fishery selectivity a50","male fishery selectivity slope","male fishery selectivity a50","survey selectivity slope","survey selectivity a50","male survey selectivity slope","female survey selectivity a50","Ricker log(alpha)","Ricker log(beta)","FMSY","log(FMSY)")

yr_p1=c(rep("-",length(nam_p1)))
pars11=cbind(nam_p1,yr_p1,round(pars1$value,2),round(pars1$std.dev,2))

pars2=pars[which(pars$name %in%c("msy","Bmsy","TotBiom","ABC_biom")),]


nam_p2=c("MSY",rep("ABC biomass",10),"Bmsy",rep("Total Biomass",length(seq(1954,thisyr,1))))
yr_p2=c("-",seq(2018,2027,1),"-",seq(1954,thisyr,1))

pars3=cbind(nam_p2,yr_p2,formatC(1000*pars2$value,format="d",big.mark=","),formatC(1000*pars2$std.dev,format="d",big.mark=","))

pars4=rbind(pars11,pars3)
colnames(pars4)=c("Parameter name","Year","Value","Standard deviation")

kable(pars4,"latex",booktabs=T,linesep="",longtable=T)
...
`r table_nums('tab_23')`
```{r tab_23}
#YFSbc=read.csv(here("/doc/Rmd/YFS_bycatch.csv"),header=TRUE)
#spp=names(table(YFSbc$Species.Group))
#spp[32]="SR/RE/Sharpchin/Northern RF"
#spp[31]="SR/RE"
#spp[30]="Sharpchin/Northern RF"
#yr=names(table(YFSbc$Year))
#YFSbcmat=matrix(0,length(spp),length(yr))
#for(i in 1:length(spp)){
# for(j in 1:length(yr)){
#  YFSbcmat[i,j]=sum(YFSbc$Weight.Posted..Sum.[which(YFSbc$Species.Group==spp[i]&YFSbc$Year==yr[j])])
# }
#}
#YFSbcmat=YFSbcmat[-1,]
#colnames(YFSbcmat)=seq(1991,thisyr,1)
#rownames(YFSbcmat)=spp[2:length(spp)]
#write.csv(YFSbcmat,here("/doc/Rmd/YFSbcmat.csv"))
YFSbcmat1=read.csv(here("/doc/Rmd/YFSbcmat.csv"),header=TRUE)
rownames(YFSbcmat1)=c()
colnames(YFSbcmat1)=c("Species group",seq(1992,thisyr,1))

Species_Group = as.character(YFSbcmat1[,1])

YFSbcmat2=cbind(Species_Group,YFSbcmat1[,-1])
colnames(YFSbcmat2)=c("Species group",seq(1992,thisyr,1))
#YFSbcmat3=YFSbcmat2[-1,]

print(kable(YFSbcmat2[,1:15],"latex",booktabs=TRUE,linesep="",digits=0, format.args = list(big.mark = ","),row.names=NA)%>%kable_styling(latex_options="scale_down"))

print(kable(YFSbcmat2[,c(1,16:29)],"latex",booktabs=TRUE,linesep="",digits=0, format.args = list(big.mark = ","),row.names=NA)%>%kable_styling(latex_options="scale_down"))
```

\pagebreak
`r table_nums('tab_24')`
```{r tab_24}
nont=read.csv(here("/doc/Rmd/YFS_nontarget.csv"),header=TRUE)
yr=names(table(nont$Year))
spp=names(table(nont$Species.Group.Name))
spp[12]="Corals Bryozoans"
spp[18]="Grenadier spp."
spp[23]="Bigmouth Sculpin"
spp[24]="Great Sculpin"
spp[25]="Hemilepidotus Unid."
spp[26]="Myoxocephalus Unid."
spp[27]="Plain Sculpin"
spp[28]="Red Irish Lord"
spp[29]="Warty Sculpin"
spp[30]="Yellow Irish Lord"
ntmat=matrix(0,length(spp),length(yr))
for(i in 1:length(spp)){
 for(j in 1:length(yr)){
  ntmat[i,j]=sum(na.omit(nont$Nontarget.Estimate..mt.[which(nont$Year==yr[j]&nont$Species.Group.Name==spp[i])]))
 }
}
colnames(ntmat)=yr
rownames(ntmat)=spp

kable(ntmat,"latex",booktabs=TRUE,linesep="",digits=1, format.args = list(big.mark = ","))%>%kable_styling(latex_options="scale_down")
...
`r table_nums('tab_25')`
```{r tab_25}
TAC_ABC=read.csv(here("/doc/Rmd/TAC_ABC.csv"),header=TRUE)
TAC_ABC1=cbind(formatC(TAC_ABC[,2],format="d",big.mark=","),formatC(TAC_ABC[,3],format="d",big.mark=","),formatC(TAC_ABC[,4],format="d",big.mark=","))
TAC_ABC2=cbind(seq(1980,thisyr,1),TAC_ABC1)
colnames(TAC_ABC2)=c("Year","TAC","ABC","Total catch (t)")
kable(TAC_ABC2,"latex",booktabs=T,linesep="",align="r")
...
#blend_catchYFS=read.csv(here("/doc/Rmd/YFS_Blend_CAS.csv"),header=TRUE)
#yrs=c(2003:2018)
#cat_month=matrix(0,length(yrs),12)
#cat_month2=matrix(0,length(yrs),12)
#for (i in 1:length(yrs)){
#cat_month[i,]=table(blend_catchYFS$Month[which(blend_catchYFS$Year==yrs[i])])
#}
...
catch_month=read.csv(here("/doc/Rmd/catch_month.csv"))
...
#blend_catch2018=blend_catchYFS[which(blend_catchYFS$Year==2018),]
...
cat_mo2018b=read.csv(here("/doc/Rmd/cat_mo2018b.csv"))
...
```{r fig_7, message=FALSE, echo=FALSE} 
include_graphics("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/yfs_cpuediff_2019.pdf",dpi=4)
```
`r figure_nums('fig_7')`
...
\begin{center}
\includegraphics[width=5in,angle=270,origin=c]{/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/Black_Fig3.pdf}
\end{center}
`r figure_nums('fig_9')`
...
\pagebreak
`r figure_nums('fig_23')`
```{r fig_23,echo=FALSE, message=FALSE,warning=FALSE}
#phase plane plot
par(mar=c(5,5,3,2))
par(mfrow=c(1,1))
F40=extra_sd$HM_Fmsyr[1] #in 2020?
B40=extra_sd$Bmsy[1]
#B35=t3.df$B35[3]#?
FOFL=extra_sd$AM_Fmsyr[1]
plot(0,0,xlim=c(0,max(YFS$`#SSB`[,2])*1.1),ylim=c(0,max(YFS$Fmort)*1.1),col=1,xlab="Estimated female spawning biomass (t)",ylab="Estimated fishing mortality rate",cex.axis=1.2,cex.lab=1.1,pch=-1,cex=.00001)
segments(0,0,B40,F40,col="green",lwd=4)
segments(B40,F40,max(YFS$`#TotBiom`[,2]*1000)*1.1,F40,col="green",lwd=4)
abline(h=FOFL,lty=1)
abline(v=B40,lty=2)
#abline(v=B35,lty=3)
legend("topright",c(expression("F" ["OFL"]),expression("B" ["35%"]),expression("B" ["40%"]),expression("F" ["ABC"])),lwd=c(1,1,1,4),lty=c(1,3,2,1), col=c("black","black","black","green"),cex=1.1,bty="n")

#note: female and male fishing mortality rate is the same
points(YFS$`#SSB`[,2]  ,YFS$Fmort,type="l",col="red",lwd=4)
#for(i in 1: 29){
#text(AI$fspbio[i]  ,AI$fishmort[i],labels=as.character(seq(1990,2018,1))[i],cex=0.9)}

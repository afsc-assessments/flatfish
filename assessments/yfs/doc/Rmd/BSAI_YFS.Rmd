...
library(bookdown)
library(ggthemes)
#source("/Users/ingridspies/admbtest/YFS/YFS/fmr/R/read-admb.R") why does this not work?
...
knitr::opts_chunk$set(setwd("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs"))
YFS=read.rep("./runs/m1/fm.rep")

B0=YFS$`#Bzero`*1000

AI=read.rep("/Users/ingridspies/admbtest/AI_Pcod/AI_Pcod.rep")
extra_sd=read.table("./runs/m1/extra_sd.rep",header=TRUE) 
...
YFS=read_rep("../runs/m0/fm.rep")
#YFSL=read.rep("./assessments/yfs/runs/m1/fm_legacy.rep")
>>>>>>> 0f4208822786d3cee92fbc6a2ba7ebe0ab0e4855
```
...
Yellowfin sole are usually headed and gutted, frozen at sea, and then shipped to Asian countries for further processing (AFSC 2016).  The first wholesale value of Alaska yellowfin sole totaled $97.8 million in 2014.  From 2016 to 2017 the first wholesale price of all Bering Sea flatfish fisheries increased 16% to $192.9 million t and yellowfin sole price increased 19% year over year. In 2010, following a comprehensive assessment process, the yellowfin sole fishery was certified under the Marine Stewardship Council environmental standard for sustainable and well-managed fisheries.  The certification also applies to all the major flatfish fisheries in the BSAI and GOA.  The total annual catch (t) since 1964 is shown in Table 4.1.
...
fig.1_cap = figure_nums(name="fig_1",caption = paste("Yellowfin sole annual total catch (1,000s t) in the Eastern Bering Sea from 1954-",thisyr,".",sep="")) 

fig.2_cap = figure_nums(name="fig_2",caption = paste("Yellowfin sole annual cumulative catch by month and year (non CDQ) 2003-",thisyr-1,".",sep=""))

fig.3_cap = figure_nums(name="fig_3",caption = paste("Size composition of the yellowfin sole catch in ",thisyr,"(through mid-September), by subarea and total.
                                                     "))

fig.4_cap = figure_nums(name="fig_4",caption = "Yellowfin sole catch by month and area in the Eastern Bering Sea in 2018.")

fig.4_cap = figure_nums(name="fig_4",caption = paste("Yellowfin sole fishery catch proportion by month in the eastern Bering Sea,"thisyr,".",sep=""))
...
retdis=read.csv("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/RetDis_full.csv",header=TRUE)#Sept 25 2019
...
#retdis2018=read.csv("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/retdis2018.csv",header=TRUE)
...
rescatch=read.csv("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/YFS_research_catch.csv",header=TRUE)
yr=names(table(rescatch$Collection_Year))
res_mat=matrix(0,length(names(table(rescatch$Collection_Year))),2)
res_mat[,1]=names(table(rescatch$Collection_Year))
for (i in 1:nrow(res_mat)){
 res_mat[i,2]=sum(rescatch$Weight[which(rescatch$Collection_Year==yr[i])])
}
cat=as.numeric(as.character(res_mat[,2]))
res_mat2=cbind(as.numeric(as.character(yr)),formatC(cat,format="d",big.mark=","))
kable(res_mat2,"latex",booktabs=T,linesep="")
```
...
mat=read.csv("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/maturity_T10.csv",header=TRUE)
...
\pagebreak
```{r fig_1b, message=FALSE, echo=FALSE}  
#blend_catchYFS=read.csv("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/YFS_Blend_CAS.csv",header=TRUE)
#yrs=c(2003:2018)
...
#write.csv(catch_month,"/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/catch_month.csv")

catch_month=read.csv("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/catch_month.csv")
...
```
\\
`r figure_nums('fig_1b')`

\pagebreak

```{r fig_3,fig.align='center',message=FALSE, echo=FALSE}  
library(scales)
par(mar=c(5,6,6,1))
...
\pagebreak  
```{r fig_4, message=FALSE, echo=FALSE} 
...
#write.csv(cat_mo2018b,"/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/cat_mo2018b.csv")
cat_mo2018b=read.csv("/Users/ingridspies/admbtest/YFS/YFS/assessments/yfs/doc/Rmd/cat_mo2018b.csv")

...
\pagebreak
`r figure_nums('fig_3')`
```{r fig_3, message=FALSE, echo=FALSE}  
library(scales)
par(mar=c(5,6,6,1))
...
geom_bar(width = 2, stat = "identity")+coord_polar("y", start=0,direction=1)+blank_theme+theme(axis.text.x=element_blank()) +geom_text(aes(label = NMFS.Area),position = position_stack(vjust = 0.5), size=c(9,5,5,5,9,9,9))+ scale_fill_discrete(name = "NMFS Area")+ theme(legend.text=element_text(size=15),legend.title=element_text(size=16))

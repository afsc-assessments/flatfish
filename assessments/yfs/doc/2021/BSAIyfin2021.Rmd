...
femcat=YFS18_2$catage_f/rowSums(YFS2$catage_f)
malcat=YFS18_2$catage_m/rowSums(YFS2$catage_m)
...
FSB_this=1000*ABC_OFL$SSB[1]
FSB_thisF=formatC(FSB_this,format="d",big.mark=",")

FSB_next=1000*ABC_OFL$SSB[2]
...
FABC_this=round(ABC_OFL$HM_Fmsyr[1],3)

FABC_next=round(ABC_OFL$HM_Fmsyr[2],3)

FOFL_this=round(ABC_OFL$AM_Fmsyr[1],3)
FOFL_next=round(ABC_OFL$AM_Fmsyr[2],3)

Bmsy_this=1000*ABC_OFL$Bmsy[1]
Bmsy_thisF=formatC(Bmsy_this,format="d",big.mark=",")

Bmsy_next=1000*ABC_OFL$Bmsy[2]
...
cn4=str_replace(c4, ",", "")
cn5=mean(as.numeric(c(cn4,Catch[35])))
...
_Changes in the data_
   ...
   2. The estimate of the total catch made through the end of `r thisyr-1` was updated as reported by the NMFS Alaska Regional office. The catch through the end of `r thisyr` was estimated based on available data to be `r Catch[35]`. Catch for the `r thisyr+1` and `r thisyr+2` projections were assumed to be the mean of the past 5 years, `r thisyr-4` - `r thisyr`, `r formatC(mean(Catch[31:35]),format="d",big.mark=",")` t.
   4. The `r thisyr` NMFS survey biomass estimate and standard error was included. The `r thisyr` Northern Bering Sea biomass estimate and standard error were combined with the `r thisyr` EBS survey VAST estimate in Model 18.2b.
   5. Fishery weight-at-age was calculated based on methodology described in the document.

_Changes in the assessment methods_

Three models are presented in this assessment. Model 18.2 is presented in full, and is the preferred model. Models 18.3 and 18.4 are presented to promote discussion on the use of VAST biomass estimates and incorporation of the Northern Bering Sea (NBS) survey.
...
*******Doing that seems reasonable and defensible as a precautionary level (assuming low tariff-impacted catches would be less precautionary, in ABC/OFL terms).
...
a=-1*(YFS2021$SSB[1:68,2]-YFS2020$SSB[,2])/YFS2021$SSB[1:68,2]  
b=-1*(YFS2021$SSB[1:67,2]-YFS2019$SSB[,2])/YFS2021$SSB[1:67,2]
c=-1*(YFS2021$SSB[1:66,2]-YFS2018$SSB[,2])/YFS2021$SSB[1:66,2]
d=-1*(YFS2021$SSB[1:65,2]-YFS2017$SSB[,2])/YFS2021$SSB[1:65,2]
e=-1*(YFS2021$SSB[1:64,2]-YFS2016$SSB[,2])/YFS2021$SSB[1:64,2]
f=-1*(YFS2021$SSB[1:63,2]-YFS2015$SSB[,2])/YFS2021$SSB[1:63,2]
g=-1*(YFS2021$SSB[1:62,2]-YFS2014$SSB[,2])/YFS2021$SSB[1:62,2]
h=-1*(YFS2021$SSB[1:61,2]-YFS2013$SSB[,2])/YFS2021$SSB[1:61,2]
i=-1*(YFS2021$SSB[1:60,2]-YFS2012$SSB[,2])/YFS2021$SSB[1:60,2]
j=-1*(YFS2021$SSB[1:59,2]-YFS2011$SSB[,2])/YFS2021$SSB[1:59,2]
k=-1*(YFS2021$SSB[1:58,2]-YFS2010$SSB[,2])/YFS2021$SSB[1:58,2]  
...
retdis=read.csv("/Users/ingridspies/admbmodels/flatfish/assessments/yfs/doc/2020/RetDis_2020.csv",header=TRUE)#Oct. 12 2020
...
Projected total (age 6+) biomass (t)  &  `r formatC(ABC_OFL$GM_Biom[1]*1000,format="d",big.mark=",")`   &  `r formatC(ABC_OFL$GM_Biom[2]*1000,format="d",big.mark=",")`  &  `r formatC(extra_sd1$GM_Biom[1]*1000,format="d",big.mark=",")`  & `r formatC(extra_sd1$GM_Biom[2]*1000,format="d",big.mark=",")` &  `r formatC(extra_sd0$GM_Biom[1]*1000,format="d",big.mark=",")`  & `r formatC(extra_sd0$GM_Biom[2]*1000,format="d",big.mark=",")` \\
Projected female spawning biomass (t) &  `r formatC(ABC_OFL$SSB[1]*1000,format="d",big.mark=",")`  &  `r formatC(ABC_OFL$SSB[2]*1000,format="d",big.mark=",")`  &  `r formatC(extra_sd1$SSB[1]*1000,format="d",big.mark=",")`  & `r formatC(extra_sd1$SSB[2]*1000,format="d",big.mark=",")` &  `r formatC(extra_sd0$SSB[1]*1000,format="d",big.mark=",")`  & `r formatC(extra_sd0$SSB[2]*1000,format="d",big.mark=",")` \\
$\:\:\:\:\:\:B_{100\%}$                           &  `r B0_2`  &  `r B0_2`  &  `r B0_1`  & `r B0_1` & `r B0_0`  & `r B0_0`  \\
$\:\:\:\:\:\:B_{MSY\%}$                            &  `r formatC(1000*ABC_OFL$Bmsy[1],format="d",big.mark=",")`  &  `r formatC(1000*ABC_OFL$Bmsy[1],format="d",big.mark=",")`  &  `r formatC(1000*extra_sd1$Bmsy[1],format="d",big.mark=",")`  & `r formatC(1000*extra_sd1$Bmsy[1],format="d",big.mark=",")`  &  `r formatC(1000*extra_sd0$Bmsy[1],format="d",big.mark=",")`  & `r formatC(1000*extra_sd0$Bmsy[1],format="d",big.mark=",")` \\
$F_{OFL}$                             &  `r round(ABC_OFL$AM_Fmsyr[1],3)`   &  `r round(ABC_OFL$AM_Fmsyr[2],3)`   &  `r round(extra_sd1$AM_Fmsyr[1],3)`  & `r round(extra_sd1$AM_Fmsyr[2],3)`  &  `r round(extra_sd0$AM_Fmsyr[1],3)`  & `r round(extra_sd0$AM_Fmsyr[2],3)` \\
$maxF_{ABC}$                          &  `r round(ABC_OFL$HM_Fmsyr[1],3)`   &   `r round(ABC_OFL$HM_Fmsyr[2],3)`   &  `r round(extra_sd1$HM_Fmsyr[1],3)`    & `r round(extra_sd1$HM_Fmsyr[2],3)` &  `r round(extra_sd0$HM_Fmsyr[1],3)`    & `r round(extra_sd0$HM_Fmsyr[2],3)`    \\
$F_{ABC}$                             &  `r round(ABC_OFL$HM_Fmsyr[1],3)`   &  `r round(ABC_OFL$HM_Fmsyr[2],3)`   &  `r round(extra_sd1$HM_Fmsyr[1],3)`   & `r round(extra_sd1$HM_Fmsyr[2],3)` &  `r round(extra_sd0$HM_Fmsyr[1],3)`   & `r round(extra_sd0$HM_Fmsyr[2],3)`   \\
$OFL$                                 &  `r formatC(1000*ABC_OFL$OFL_AM[1],format="d",big.mark=",")`  &  `r formatC(1000*ABC_OFL$OFL_AM[2],format="d",big.mark=",")`  &  `r formatC(1000*extra_sd1$OFL_AM[1],format="d",big.mark=",")`  & `r formatC(1000*extra_sd1$OFL_AM[2],format="d",big.mark=",")` &  `r formatC(1000*extra_sd0$OFL_AM[1],format="d",big.mark=",")`  & `r formatC(1000*extra_sd0$OFL_AM[2],format="d",big.mark=",")`
\\
$maxABC$                              &  `r formatC(1000*ABC_OFL$ABC_HM[1],format="d",big.mark=",") ` &  `r formatC(1000*ABC_OFL$ABC_HM[2],format="d",big.mark=",") `  &  `r formatC(1000*extra_sd1$ABC_HM[1],format="d",big.mark=",") `  & `r formatC(1000*extra_sd1$ABC_HM[2],format="d",big.mark=",") ` &  `r formatC(1000*extra_sd0$ABC_HM[1],format="d",big.mark=",") `  & `r formatC(1000*extra_sd0$ABC_HM[2],format="d",big.mark=",") ` \\
$ABC$                                 &  `r formatC(1000*ABC_OFL$ABC_HM[1],format="d",big.mark=",") `  &  `r formatC(1000*ABC_OFL$ABC_HM[2],format="d",big.mark=",") ` & `r formatC(1000*extra_sd1$ABC_HM[1],format="d",big.mark=",") `  & `r formatC(1000*extra_sd1$ABC_HM[2],format="d",big.mark=",") ` &  `r formatC(1000*extra_sd0$ABC_HM[1],format="d",big.mark=",") `  & `r formatC(1000*extra_sd0$ABC_HM[2],format="d",big.mark=",") ` \\
\hline
...
biom=data.frame(1000*YFS18_2$SSB[,c(2,4,5)],1000*YFS18_2a$SSB[,c(2,4,5)])

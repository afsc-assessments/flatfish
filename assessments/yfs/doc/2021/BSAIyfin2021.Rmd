...
par(mar=c(5,5,3,2))
par(mfrow=c(1,1))
F40=ABC_OFL$HM_Fmsyr[1]
B40=ABC_OFL$Bmsy[1]
FOFL=ABC_OFL$AM_Fmsyr[1]
...
points(ABC_OFL$SSB[1],ABC_OFL$Catch_Assump[1]/ABC_OFL$GM_Biom[1],pch=15,col="blue")
text(ABC_OFL$SSB[1],(ABC_OFL$Catch_Assump[1]/ABC_OFL$GM_Biom[1])+.005,"2021",cex=0.9)

points(ABC_OFL$SSB[2]+20,ABC_OFL$Catch_Assump[2]/ABC_OFL$GM_Biom[2],pch=15,col="black")
text(ABC_OFL$SSB[2]-60,(ABC_OFL$Catch_Assump[2]/ABC_OFL$GM_Biom[2])+.005,"2022",cex=0.9)

...
# for (i in 0:4) { rn=paste0("m",i,"/For_R.rep") mn=paste0("mod",i) assign(mn,readList(rn)) print(rn) }

mod1 <- readList("arc/mod01_R.rep")
mod6_2015 <- readList("arc/mod6_2015_R.rep")
mod7_2015 <- readList("arc/mod7_2015_R.rep")
mod1_2014 <- readList("arc/mod1_2014_R.rep")

.OVERlAY=TRUE
modset1 <- list( '1_2016' = mod1, '6_2015' = mod6_2015 )
modset2 <- list( '1_2016' = mod1, '6_2015' = mod6_2015, '7_2015' = mod7_2015 )
modset3 <- list( '1_2016' = mod1, '1_2014' = mod1_2014, '6_2015' = mod6_2015, '7_2015' = mod7_2015 )
plot_ssb(modset1,alpha=.3)
plot_ssb(modset2,alpha=.3,xlim=c(1990,2016))
plot_ssb(modset3,alpha=.3,xlim=c(1990,2016))
plot_srr(modset2,alpha=.2)
plot_srr(modset3,alpha=.2)
plot_bts(modset1)
plot_bts(modset3)
,xlim=c(0,5000),ylim=c(0,80000))

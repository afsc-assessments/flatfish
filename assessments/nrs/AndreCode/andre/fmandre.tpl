...
PROCEDURE_SECTION
  ...
  if (mceval_phase())
  {
   ...
   // AEP last line the N matrix
   projout << natage_f(endyr) << endl;
   projout << natage_m(endyr) << endl;
   cout << "out" << endl;
  } 
...
//  kill them off till they spawn and convert from numbers to biomass
   ...
   //cout << Ntmp << endl;
   //cout << wt_pop_fut_f << endl;
   //cout << spmo_frac << endl;
   //cout << maturity(endyr) << endl;
   return(phi);
...
FUNCTION Get_wt_age
  incr_dev.initialize();
  cout << "get_wt_age " << active(growth_alpha) << endl;
  if (active(yr_incr)||active(age_incr)||active(growth_alpha))
  {
    switch (Growth_Option)
    {
      ...
      case 3 : // Use base growth values (not estimated) and deviations as fn of temperature and // decomposed by year and age
      {
        ...
        for (i=styr+1;i<=endyr;i++)
        {
          ...
          // if (i >=1982)
            ...
            cout << growth_alpha << endl;
            cout << growth_cov(i) << endl;
          // else 
...
FUNCTION Write_R_wts
  ...
  R_report<<"wt_fsh_f" <<endl;
  R_report<<  wt_fsh_f  <<endl;
  R_report<<"wt_fsh_m" <<endl;
  R_report<<  wt_fsh_m  <<endl;
  R_report<<"wt_pop_f" <<endl;
  R_report<<  wt_pop_f  <<endl;
  R_report<<"wt_pop_m" <<endl;
  R_report<<  wt_pop_m  <<endl;
  R_report<<"wt_pop_fut_f" <<endl;
  R_report<<  wt_pop_fut_f  <<endl;
  R_report<<"wt_pop_fut_m" <<endl;
  R_report<<  wt_pop_fut_m  <<endl;
